...
class YourPostsAndFavouriteCarousel extends StatefulWidget {
  late final PageController? pageController;
  final String? title;
  final List? posts;
  YourPostsAndFavouriteCarousel({this.pageController,this.title,this.posts});

  @override
  _YourPostsAndFavouriteCarouselState createState() => _YourPostsAndFavouriteCarouselState();
}

class _YourPostsAndFavouriteCarouselState extends State<YourPostsAndFavouriteCarousel> {
